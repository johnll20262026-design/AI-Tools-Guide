              ...
              <div className="py-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                  <div className="rounded-xl bg-card border border-border p-4 text-center hover:border-green-500/30 transition-colors">
                    <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-[#07c160]/15 mb-2">
                  ...
                  <div className="rounded-xl bg-card border border-border p-4 text-center hover:border-blue-500/30 transition-colors">
                    <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-[#1677ff]/15 mb-2">
                      <span className="text-lg font-bold text-white" style={{ fontFamily: 'serif' }}>支</span>
                    </div>
