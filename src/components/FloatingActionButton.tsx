  ...
  return (
    <>
      ...
      <Dialog open={dialogType !== null} onOpenChange={(open) => !open && closeDialog()}>
        <DialogContent className={dialogType === 'donate' ? 'sm:max-w-2xl' : 'sm:max-w-md'}>
          ...
          {currentDialog && dialogType === 'donate' && (
            <div className="py-2">
              <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/20 to-teal-500/20 mb-4">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-foreground tracking-tight leading-tight">
                  为极致体验
                  <br />
                  <span className="text-muted-foreground">注入持续动力</span>
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6">
                <div className="rounded-2xl bg-card border border-border p-5 text-center hover:border-green-500/30 transition-colors">
                  ...
                  <h3 className="text-lg font-bold text-foreground mb-1">微信支付</h3>
                  <p className="text-xs text-muted-foreground mb-4">打开微信扫一扫，金额随意</p>
                  <div className="flex justify-center">
                    <QrCodeImage size="md" label="微信收款码" src="/wechat-pay.png" className="!w-40 !h-40" />
                  </div>
                </div>

                <div className="rounded-2xl bg-card border border-border p-5 text-center hover:border-blue-500/30 transition-colors">
                  <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-500/10 mb-3">
                    <span className="text-2xl font-bold text-blue-500" style={{ fontFamily: 'serif' }}>支</span>
                  </div>
                  <h3 className="text-lg font-bold text-foreground mb-1">支付宝</h3>
                  <p className="text-xs text-muted-foreground mb-4">打开支付宝扫一扫，感谢支持</p>
                  <div className="flex justify-center">
                    <QrCodeImage size="md" label="支付宝收款码" src="/alipay.png" className="!w-40 !h-40" />
                  </div>
                </div>
              </div>

              <div className="text-center px-4 py-3 rounded-xl bg-muted/30 mb-6">
                <p className="text-xs text-muted-foreground leading-relaxed">
                  * 您的每一份支持，都将被用于服务器运维、内容创作与工具迭代，
                  <br className="hidden md:block" />
                  确保优质教程始终免费、持续更新、无广告干扰。
                </p>
              </div>

              <div className="text-center">
                <p className="text-sm text-foreground font-medium mb-3">有新的功能想法？</p>
